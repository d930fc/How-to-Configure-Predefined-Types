...
h<sub>2</sub> = (hash(x) + f(2)) % TableSize<br/>
…<br/>
...
线性探测散列的f(i)是一次函数。流行的选择是f(i)=i。<br/>
f(0) = 0<br/>
f(1) = 1<br/>
f(2) = 2<br/>
…<br/>
...
平方探测散列的f(i)是二次函数。流行的选择是f(i)=i<sup>2</sup>。<br/>
f(0) = 0<br/>
f(1) = 1<br/>
f(2) = 4<br/>
…<br/>
...
双散列的f(i)是一个哈希函数。流行的选择是f(i)=i·hash<sub>2</sub>(x)。<br/>
f(0) = 0<br/>
